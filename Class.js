/* Reference Type: */ console.log('1. Reference Type:')
var obj1 = { value: 10 };
...
/* Context vs Scope: */ console.log('2. Context vs Scope:')
...
const obj4 = {  // Context is created with Object a!
  a: function() {
...
class Player {
  ...
  introduce() {
    console.log('From Introduce Method: ', `Hi I am ${this.name}, I'm a ${this.type}`)
  }
}
